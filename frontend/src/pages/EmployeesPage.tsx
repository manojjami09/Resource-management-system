  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full md:w-auto">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-3 py-2 rounded-lg border border-slate-200 text-sm w-full sm:w-72 bg-white focus:outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-50 transition-all"
            />
          </div>
          <button
      ...
      <Tabs defaultValue="all" className="w-full">
        <TabsList className="mb-4 w-full justify-start overflow-x-auto flex-nowrap hide-scrollbar">
          <TabsTrigger value="all" onClick={() => setPage(1)} className="whitespace-nowrap">All Employees</TabsTrigger>
          <TabsTrigger value="available" onClick={() => setPage(1)} className="whitespace-nowrap">Available (30 Days)</TabsTrigger>
          <TabsTrigger value="matrix" className="whitespace-nowrap">Skill Matrix</TabsTrigger>
        </TabsList>
